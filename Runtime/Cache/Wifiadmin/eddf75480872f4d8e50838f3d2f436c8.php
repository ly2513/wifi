                    ...
                    <div class="span8 column">
                        ...
                        <div class="alert span9" style="display: none;">
						  <span id="alertmsg"></span>
                            ...
                            <div class="field-box">
                                <label>商户名称:</label>
                                <input class="span8" type="text"  data-toggle="tooltip" data-trigger="focus" title="商户名称不能超过20个字" data-placement="right" name="shopname" id="shopname" value="<?php echo ($shop["shopname"]); ?>"/>
                            ...
                            <div class="field-box">
                                <label>路由注册上限:</label>
                                 ...
                                 <div class="span8">
                                    <label class="radio">
                                    <input type="radio" name="linkflag" value="0" <?php if(($shop['linkflag']) == "0"): ?>checked<?php endif; ?>>限制(免费注册用户)
                                        	
                                    </label>
                                    <label class="radio">
                                               <input type="radio" name="linkflag" value="1" <?php if(($shop['linkflag']) == "1"): ?>checked<?php endif; ?>>不限制(付费用户或代理商开户)
                             ...
                             <div class="field-box">
                                <label>路由注册上限:</label>
                                <input class="span8" type="text" name="maxcount" id="maxcount" value="<?php echo ($shop["maxcount"]); ?>" />
                            </div>
                             <div class="field-box">
                                <label>消费水平:</label>
                                 <?php if(is_array($enumdata["shoplevel"])): $i = 0; $__LIST__ = $enumdata["shoplevel"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><label class="checkbox">
                             ...
                             <div class="field-box">
                                <label>行业类别:</label>
                                 <?php if(is_array($enumdata["trades"])): $i = 0; $__LIST__ = $enumdata["trades"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><label class="checkbox">
                             ...
                             <div class="field-box">
                                <label>地址:</label>
                                <input class="span8" type="text"  data-toggle="tooltip" data-trigger="focus" title="输入商铺所在地址" data-placement="right" name="address" id="address" value="<?php echo ($shop["address"]); ?>"/>
                            </div>
                              <div class="field-box ">
                              
                              <input type="hidden" name="sid" id="sid" value="<?php echo ($shop["id"]); ?>">
  ...
  <script src="<?php echo ($Theme['P']['root']); ?>/bootadmin/js/common.js"></script>
           <script src="<?php echo ($Theme['P']['js']); ?>/region_select.js"></script>
                    <script type="text/javascript">
                        new PCAS('province', 'city', 'area', '<?php echo ($shop['province']); ?>', '<?php echo ($shop["city"]); ?>', '<?php echo ($shop["area"]); ?>');
                    </script>

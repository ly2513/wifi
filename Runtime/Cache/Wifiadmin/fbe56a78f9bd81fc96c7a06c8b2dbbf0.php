                    ...
                    <div class="span8 column">
                        ...
                        <div class="alert span10" style="display: none;">
						  <span id="alertmsg"></span>
                         	...
                         	<div class="field-box">
                                <label>路由默认注册上限:</label>
                                <input class="span8" type="text"  data-toggle="tooltip" data-trigger="focus" title="请输入路由器默认注册用户上限" data-placement="right" name="OpenMaxCount" id="OpenMaxCount" value="<?php echo C('OpenMaxCount');?>"/>
                            </div>
                             
               
                   <input type="hidden" name="files" value="route.php" />

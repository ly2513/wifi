                    ...
                    <div class="span8 column">
                        ...
                        <div class="alert span10" style="display: none;">
						  <span id="alertmsg"></span>
                         	...
                         	<div class="field-box">
                                <label>登录帐号:</label>
                                <input class="span8" type="text"  data-toggle="tooltip" data-trigger="focus" title="4-20位数字，字母或下划线组成" data-placement="right" name="user" id="user" value="<?php echo ($info["user"]); ?>" maxlength="20" readonly='readonly'/>
                            </div>
                            <div class="field-box">
                                <label>登录密码:</label>
                            ...
                            <div class="field-box">
                                <label>所属角色:</label>
                              <select name="role">
                              	<?php if(is_array($role)): $i = 0; $__LIST__ = $role;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if(($vo["id"]) == $info["role"]): ?>selected=""<?php endif; ?> /> <?php echo ($vo["name"]); endforeach; endif; else: echo "" ;endif; ?>
                              </select>
                            </div>
                             <div class="field-box">
                                <label>备注信息:</label>

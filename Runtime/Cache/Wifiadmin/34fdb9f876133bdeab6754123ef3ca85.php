                    ...
                    <div class="span8 column">
                        ...
                        <div class="alert span10" style="display: none;">
						  <span id="alertmsg"></span>
                         	...
                         	<div class="field-box">
                                <label>标题:</label>
                                <input class="span8" type="text"  data-toggle="tooltip" data-trigger="focus" title="请输入标题" data-placement="right" name="title" id="title" value=""/>
                            </div>
                            <div class="field-box">
                                <label>所属栏目:</label>
                                <select name="mode" >
                             ...
                             <div class="field-box">
                               ...
                               <textarea rows="6" class="span8 wysihtml5" name="info" id="info"></textarea>
                                </div>

                                ...
                                <label>代理商级别:</label>
                                 <div class="ui-select">
                                    <select name="level" id="level"><option value="-1">选择代理商等级</option>
                                    	<?php if(is_array($lvlist)): $i = 0; $__LIST__ = $lvlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if(($info['level']) == $vo['id']): ?>selected<?php endif; ?>><?php echo ($vo["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                </div>
                            </div>
                         <div class="field-box">
                                <label>登录帐号:</label>
                                <input class="span8" type="text"  data-toggle="tooltip" data-trigger="focus" title="4-20个字母，数字组成" data-placement="right" name="user" id="user" readonly="readonly" value="<?php echo ($info["account"]); ?>"/>
                            </div>
                             <div class="field-box">
                                <label>登录密码:</label>
                           ...
                           <div class="field-box">
                                <label>代理商名称:</label>
                                <input class="span8" type="text"  data-toggle="tooltip" data-trigger="focus" title="代理商名称不能超过20个字" data-placement="right" name="name" id="name" value="<?php echo ($info["name"]); ?>"/>
                            	
                            </div>
                             <div class="field-box">
                                <label>联系人:</label>
                                <input class="span8" type="text" name="linker" id="linker" value="<?php echo ($info["linker"]); ?>"/>
                            </div>
                              <div class="field-box">
                                <label>手机号码:</label>
                                <input class="span8" type="text" name="phone" id="phone" value="<?php echo ($info["phone"]); ?>" />
                            </div>
                                 <div class="field-box">
                                 <label>加盟费用:</label>
                                <input class="span8" type="text"  name="fee" id="fee" value="<?php echo ($info["fee"]); ?>"/>
                            </div>
                             ...
                             <div class="field-box">
                                <label>地址:</label>
                                <input class="span8" type="text"   name="address" id="address" value="<?php echo ($info["address"]); ?>"/>
                            </div>
                            <div class="field-box">
                                <label>状态:</label>
                             	 <div class="span8">
                                    <label class="radio">
                                        <input type="radio" name="state" id="status1" value="1" <?php if(($info['state']) == "1"): ?>checked<?php endif; ?>/>
                                        	正常
                                    </label>
                                    <label class="radio">
                                        <input type="radio" name="state" id="status2" value="0" <?php if(($info['state']) == "0"): ?>checked<?php endif; ?>/>
                                        		停用
                                    </label>
                                </div>                   
                            </div>

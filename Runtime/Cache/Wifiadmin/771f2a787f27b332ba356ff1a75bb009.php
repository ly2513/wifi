                    ...
                    <div class="span8 column">
                        ...
                        <div class="alert span10" style="display: none;">
						  <span id="alertmsg"></span>
                         	...
                         	<div class="field-box">
                                <label>角色名称:</label>
                                <input class="span8" type="text"  data-toggle="tooltip" data-trigger="focus" title="请输入角色名称" data-placement="right" name="name" id="name" value="<?php echo ($info['name']); ?>"/>
                            </div>
                             <div class="field-box">
                                <label>备注信息:</label>
                                <input class="span8" type="text"  name="remark" id="remark" value="<?php echo ($info["remark"]); ?>"/>
                            </div>
                           <div class="field-box">
                                <label>角色状态:</label>
                             	 <div class="span8">
                                    <label class="radio">
                                        <input type="radio" name="status" id="status1" value="1" <?php if(($info['status']) == "1"): ?>checked<?php endif; ?> />
                                        	正常
                                    </label>
                                    <label class="radio">
                                        <input type="radio" name="status" id="status2" value="0" <?php if(($info['status']) == "0"): ?>checked<?php endif; ?>/>
                                        		停用
                                    </label>
                                </div>                   
                            </div>
                              ...
                              <div class="field-box ">
                                ...
                                &nbsp;
								<a class="btn-glow  " href="<?php echo U('role');?>">返回列表</a>
                            </div>
                        </form>
                    </div>

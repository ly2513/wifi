                    ...
                    <div class="span8 column">
                        ...
                        <div class="alert span10" style="display: none;">
						  <span id="alertmsg"></span>
                         	...
                         	<div class="field-box">
                                <label>操作帐号:</label>
                                <input class="span8" type="text"   name="account" id="account" value="<?php echo ($info["account"]); ?>" readonly/>
                            </div>
                           ...
                           <div class="field-box">
                                <label>操作类别:</label>
                             	 <div class="span8">
                             	  <label class="radio">
                                        <input type="radio" name="do" value="0" checked/>
                                        		扣款
                                    </label>
                                    <label class="radio">
                              ...
                              <div class="field-box">
                                <label>操作金额:</label>
                                <input class="span8" type="text"  name="paymoney" id="paymoney" value=""/>
                            </div>
                                 <div class="field-box">
                                <label>备注信息:</label>
                                <input class="span8" type="text"  name="desc" id="desc" value=""/>
                            </div>
                              <div class="field-box ">

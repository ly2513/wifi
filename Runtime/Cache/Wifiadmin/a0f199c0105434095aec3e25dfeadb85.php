                        ...
                        <tbody>
                            ...
                            <tr class="<?php if(($i) == "1"): ?>first<?php endif; ?>">
                                ...
                                <td>
                                 ...
                                 <td><img src="<?php echo ($vo["pic"]); ?>" class="thumb"  style="width:100px;"></td>
                               <td>
                                   <?php echo (date('Y-m-d ',$vo["startdate"])); ?>到<?php echo (date('Y-m-d ',$vo["enddate"])); ?>
                                </td>
                                <td>
                                	<?php if($vo['aid'] > 0): echo ($vo["agentname"]); else: ?>平台广告<?php endif; ?>
                                ...
                                <td>
                                  <a href="<?php echo U('edit',array('id'=>$vo['id']));?>">编辑</a>|
                                   <a href="<?php echo U('del',array('id'=>$vo['id']));?>">删除</a>
                                </td>

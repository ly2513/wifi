                    ...
                    <div class="span8 column">
                        ...
                        <div class="alert span10" style="display: none;">
						  <span id="alertmsg"></span>
                         	...
                         	<div class="field-box">
                                <label>等级名称:</label>
                                <input class="span8" type="text"  data-toggle="tooltip" data-trigger="focus" title="请输入名称" data-placement="right" name="title" id="title" value=""/>
                            </div>
                             <div class="field-box">
                                <label>开户金额:</label>
                                <input class="span8" type="text"  name="openpay" id="openpay" value=""/>
                            </div>
                             <div class="field-box">
                                <label>备注信息:</label>
                                <input class="span8" type="text"  name="note" id="note" value=""/>
                            </div>
                           <div class="field-box">
                                <label>状态:</label>
                             	 <div class="span8">

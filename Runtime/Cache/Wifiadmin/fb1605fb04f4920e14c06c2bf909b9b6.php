                    ...
                    <div class="span8 column">
                        ...
                        <div class="alert span10" style="display: none;">
						  <span id="alertmsg"></span>
                         	...
                         	<div class="field-box">
                                <label>网站名称:</label>
                                <input class="span8" type="text"  data-toggle="tooltip" data-trigger="focus" title="请输入网站名称" data-placement="right" name="sitename" id="sitename" value="<?php echo C('sitename');?>"/>
                            </div>
                             <div class="field-box">
                                <label>URL网址:</label>
                                <input class="span8" type="text"  data-toggle="tooltip" data-trigger="focus" title="请输入网站绑定的URL地址" data-placement="right" name="siteurl" id="siteurl" value="<?php echo C('siteurl');?>"/>
                            </div>
                           <div class="field-box">
                                <label>备案信息:</label>
                                <input class="span8" type="text"  data-toggle="tooltip" data-trigger="focus" title="输入网址的备案信息" data-placement="right" name="copyright" id="copyright" value="<?php echo C('copyright');?>"/>
                            	
                            </div>
                             <div class="field-box">
                                <label>SEO关键词:</label>
                                <input class="span8" type="text" name="keyword" id="keyword" value="<?php echo C('keyword');?>"/>
                            </div>
                              <div class="field-box">
                                <label>网站描述信息:</label>
                                 <textarea class="span8"  data-toggle="tooltip" data-trigger="focus" title="请输入网站描述信息" data-placement="right" name="content" id="content" ><?php echo C('content');?></textarea>

                            </div>
                              <div class="field-box">
                                <label>联系QQ:</label>
                                <input class="span8" type="text" data-toggle="tooltip" data-trigger="focus" title="请输入qq号码" data-placement="right" name="qq" id="qq" value="<?php echo C('qq');?>"/>
                             </div>
                               <div class="field-box">
                                <label>联系电话:</label>
                                <input class="span8" type="text" data-toggle="tooltip" data-trigger="focus" title="请输入电话号码" data-placement="right" name="linktel" id="linktel" value="<?php echo C('linktel');?>"/>
                             </div>
                            <div class="field-box">
                                <label>地址:</label>
                                <input class="span8" type="text" data-toggle="tooltip" data-trigger="focus" title="联系地址" data-placement="right" name="address" id="address"  value="<?php echo C('address');?>"/>

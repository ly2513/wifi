                        ...
                        <tbody>
                            ...
                            <tr class="<?php if(($i) == "1"): ?>first<?php endif; ?>">
                                ...
                                <td>
                                 ...
                                 <td>
                                   <?php echo ($role[$vo['role']]); ?>
                                </td>
                                  <td>
                                   <?php echo getStatus($vo['state']);?>
                                </td>
                                 <td>
                                   <?php echo (date('Y-m-d H:i',$vo["last_logintime"])); ?>
                                </td>
                                <td>
                                  
                                  <a href="<?php echo U('edituser',array('id'=>$vo['id']));?>"> 编辑     </a>&nbsp;&nbsp;
                                   <a href="javascript:drop_confirm('您确定要删除吗?','<?php echo U('deluser',array('id'=>$vo['id']));?>');" > 删除     </a>
                                </td>

...
<div id="content-header">
  <div id="breadcrumb"> <a href="<?php echo U('user/index');?>" title="返回首页" class="tip-bottom"><i class="icon-home"></i>首页</a>  <a href="#" class="current">路由添加</a> </div>
  <h1>路由添加</h1>
</div>
<div class="container-fluid">
  ...
  <div class="row-fluid">
    <div class="span8">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
 		...
 		<form class="form-horizontal" name='form' action="<?php echo U('addroute');?>" method="post" enctype="multipart/form-data">
			...
			<div class="control-group">
              ...
              <input type="text" class="span5" placeholder="输入路由标记名称 "  name="routename" id="routename"  />
            ...
            <div class="control-group"  id="wxacc">
              ...
              <div class="controls">
                <input type="text" class="span5" placeholder="输入路由mac "  name="gw_id" id="gw_id"  />
       ...
       <div class="control-group"  >
              ...
              <div class="controls">
                <input type="text" class="span5" placeholder="HotSpot账号 "  name="hotspotname" id="hotspotname"  />
   ...
   <div class="control-group"  >
              ...
              <div class="controls">
                <input type="text" class="span5" placeholder="HotSpot密码 "  name="hotspotpass" id="hotspotpass"  />

...
<!--breadcrumbs-->
  ...
  <div id="breadcrumb"> <a href="<?php echo U('user/index');?>" title="返回首页" class="tip-bottom"><i class="icon-home"></i>首页</a><a href="#" class="current">营销管理</a> </div>
  <h1>手机号码管理</h1>
  </div>
<!--End-breadcrumbs-->
      ...
      <div class="span12">
        ...
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"> <i class="icon-th"></i></span>
            <h5>统计列表</h5>
           <a href="<?php echo U('adv/downphone');?>" class="btn btn-mini btn-primary pull-right">导出号码</a>
          </div>

...
<div id="content">
  ...
  <div class="container-fluid">
    ...
    <div class="row-fluid">
      <div class="span12">
             <div class=""><a href="<?php echo U('web/addcatelog');?>" class="btn btn-success">添加栏目</a></div>
            ...
            <table class="table table-bordered table-striped">
              ...
              <tbody>
           	<?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
	        			...
	        			<td><?php echo getCatelog($vo['mode']);?></td>
	        			<td><img src="<?php echo ($vo["titlepic"]); ?>" class="thumb"></td>
	        			<td><?php echo (date('Y-m-d ',$vo["add_time"])); ?></td>
	        			<td><?php echo ($vo["sort"]); ?></td>
	        			<td><a href="<?php echo U('editcatelog',array('id'=>$vo['id']));?>" class="btn btn-primary btn-mini">编辑</a>&nbsp;&nbsp;<a href="javascript:drop_confirm('您确定要删除吗?','<?php echo U('web/delcatelog',array('id'=>$vo['id']));?>');" class="btn btn-danger btn-mini">删除</a> </td>

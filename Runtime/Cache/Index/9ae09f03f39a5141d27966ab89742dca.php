...
<!--End-breadcrumbs-->
  ...
  <div class="row-fluid">
    <div class="span8">
      <div class="widget-box">
        ...
        <form action="<?php echo U('index/web/addcatelog');?>" method="post" class="form-horizontal" enctype="multipart/form-data">
 <div class="control-group">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" placeholder="栏目名称 "  name="title" id="title" value="" />
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
              	<textarea name="info" id="info" class="span11"></textarea>  
              </div>
            </div>
             ...
             <div id="box2" class="hide box">
	             <div class="control-group">
	              ...
	              <div class="controls">
	 					<input type="text" class="span11" placeholder="请输入电话号码"  name="tel" id="tel" value="<?php echo ($wapinfo["tel"]); ?>" />
	              </div>
	            </div>
            </div>
            <div id="box1" class="hide box">
	             <div class="control-group">
	              ...
	              <div class="controls">
	 					<input type="text" class="span11" placeholder="请输入网址"  name="url" id="url" value="<?php echo ($wapinfo["url"]); ?>" />
	              </div>
	            </div>
            </div>
            <div id="box3" class="hide box">
             ...
             <div class="control-group">
	              ...
	              <div class="controls">
	 					<input type="text" class="span4" placeholder=""  name="sort" id="sort" value="0" />
	              </div>
	            </div>

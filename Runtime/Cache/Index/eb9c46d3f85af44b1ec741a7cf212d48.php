...
<div id="content-header">
  <div id="breadcrumb"> <a href="<?php echo U('User/Index');?>" title="返回首页" class="tip-bottom"><i class="icon-home"></i>首页</a>  <a href="#" class="current">广告时间设置</a> </div>
  <h1>认证广告时间</h1>
</div>
    ...
    <div class="span8">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
 		...
 		<form class="form-horizontal" name='form' action="<?php echo U('adshowtimeset');?>" method="post" enctype="multipart/form-data">
			...
			<div class="control-group">
              ...
              <input type="text" class="span5" placeholder="输入查看广告时间"  name="ad_show_time" id="routename"  value="<?php echo ($info['ad_show_time']); ?>"/>
              <span class="help-block">强制查看广告时间（部分有强制广告时间的模板使用）（单位：秒）</span> 
            ...
            <div class="form-actions">
              ...
              <a href="<?php echo U('Authset/tplset');?>" class="btn" id="btn-back">返回</a>
            </div>
          </form>
        </div>
      </div>

...
<!--breadcrumbs-->
  ...
  <div id="breadcrumb"> <a href="<?php echo U('user/index');?>" title="返回首页" class="tip-bottom"><i class="icon-home"></i>首页</a><a href="#" class="current">营销管理</a> <a href="#">短信发送列表</a></div>
  </div>
<!--End-breadcrumbs-->
            ...
            <table class="table table-bordered table-striped">
              ...
              <tbody>
           	<?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
	        			...
	        			<td><?php echo ($vo["lens"]); ?></td>
	        			<td><?php echo ($vo["unit"]); ?></td>

	        			<td>
                  <?php if($vo['send_time'] == '' ): ?>无
                    <?php else: ?> <?php echo (date('Y-m-d H:i',$vo["send_time"])); endif; ?>
                </td>
	        			<td><?php echo smsstate($vo['state']);?></td>

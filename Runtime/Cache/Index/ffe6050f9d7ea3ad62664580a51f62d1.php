 		...
 		<form class="form-horizontal" name='form' action="<?php echo U('doadv');?>" method="post" enctype="multipart/form-data">
			...
			<div class="control-group">
              ...
              <div class="controls">
                ...
                <label>
                  <input type="radio" name="ad_pos" value="0" checked>首页

<?php if($len < 2 ): ?></label>
  <label>

   <input type="radio" name="ad_pos" value="1" checked>认证页面<?php endif; ?>
                 </label>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                ...
                <label>
                 <input type="radio" name="mode" value="0" checked>图片广告
                 </label>
                   <label>
                   <input type="radio" name="mode" value="1">图文广告
                 </label>          
            ...
            <div class="control-group"  id="wxacc">
              ...
              <div class="controls">
                <input type="text" class="span5" placeholder="图文标题 "  name="title" id="title"  />
            ...
            <div class="control-group"  id="wxacc">
              ...
              <div class="controls">
                <textarea class="textarea_editor span11" rows="20" placeholder="输入内容 ..." name="info"></textarea>
              </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group" id="wxauth" >
              ...
              <div class="controls">
                <input type="text" class="span2" placeholder="数值越大越靠前 " name="ad_sort" id="ad_sort" value="0"/>
              </div>
            </div>

...
<section id="wrapper" class="wrapper">
   ...
   <section class="slide-photos">
	    <ul class="slides">
	      	<?php if($info['openpush'] == 1): if(!empty($ad)): if(is_array($ad)): $i = 0; $__LIST__ = $ad;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div  class="swiper-slide">
			     			<li style="display: list-item; background-image: url(<?php echo ($vo["pic"]); ?>);">
			     			 	<a href=""><img src="<?php echo ($vo["pic"]); ?>"></a>
			     			</li>
			...
			<?php else: ?>
				<?php if(is_array($ad)): $i = 0; $__LIST__ = $ad;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div  class="swiper-slide">
		     			<li style="display: list-item; ">
		     			 	<a href=""><img src="<?php echo ($vo["ad_thumb"]); ?>"></a>
		     			</li>
		     		</div><?php endforeach; endif; else: echo "" ;endif; endif; ?>
		</ul>
   	</section>  

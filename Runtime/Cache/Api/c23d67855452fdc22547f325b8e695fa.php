...
<section id="wrapper" class="wrapper">
   ...
   <section class="index-wrap">
      <div class="logo"><img src="<?php echo ($shopinfo[0]['logo']); ?>" alt=""></div>
      <h1 class="title"><?php echo ($shopinfo[0]['shopname']); ?></h1>
      <address class="address">
         地址：<?php echo ($shopinfo[0]['address']); ?>         <br>
         电话：<?php echo ($shopinfo[0]['phone']); ?>      </address>
         <a class="tel" href="tel:<?php echo ($shopinfo[0]['phone']); ?>"><?php echo ($shopinfo[0]['phone']); ?></a>
